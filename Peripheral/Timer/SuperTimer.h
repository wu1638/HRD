 ...
 * @LastEditTime: 2022-11-14 11:05:09
 * @LastEditors: xiao
 */
...
#define TIMER4_COUNT_CLK_FEQ 84 - 1 // 设置分频值
#define TIMER4_PERIOD_US 1750 - 1      // 计数周期

#define TIMER6_COUNT_CLK_FEQ 840-1 // 设置分频值
#define TIMER6_PERIOD_US 65535   // 计数周期
...
extern void BSP_Timer_SetCallback_MBmaster(TimerCallBack callBack); //定时器4 MB主机用
extern void BSP_Timer_SetCallBack_1s(TimerCallBack callBack);       //定时器7		1s
