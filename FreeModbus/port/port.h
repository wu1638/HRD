...
#define SLAVE_RS485_TX_MODE HAL_GPIO_WritePin(GPIOD, GPIO_PIN_7, GPIO_PIN_SET)
#define SLAVE_RS485_RX_MODE HAL_GPIO_WritePin(GPIOD, GPIO_PIN_7, GPIO_PIN_RESET)

#define MASTER_RS485_TX_MODE HAL_GPIO_WritePin(GPIOH, GPIO_PIN_8, GPIO_PIN_SET)
#define MASTER_RS485_RX_MODE HAL_GPIO_WritePin(GPIOH, GPIO_PIN_8, GPIO_PIN_RESET)
