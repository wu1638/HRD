					   ...
					   eMBParity eParity)
{
	...
	{
		printf("Create Slave event_serial Event success!\r\n");
	}
	else
	{
		printf("Create Slave event_serial Event  Faild!\r\n");
	}
	BaseType_t xReturn =
	...
	if (xReturn == pdPASS)
	{
		printf("xTaskCreate slave trans success\r\n");
	}
	return TRUE;
}
...
void vMBPortSerialEnable(BOOL xRxEnable, BOOL xTxEnable)
{
	...
	if (xRxEnable)
	{
		...
		printf("RS485_RX_MODE\r\n");
		SLAVE_RS485_RX_MODE;
	}
	else
	{
		/* switch 485 to transmit mode */
		printf("RS485_TX_MODE\r\n");
		SLAVE_RS485_TX_MODE;
